...
for memory in 64M 128M 256M 512M 1G 2G; do
...
"$temporary/arm-fdt" "$temporary/512M.dtb" 131072 32
"$temporary/arm-fdt" "$temporary/1G.dtb" 262144 32
"$temporary/arm-fdt" "$temporary/2G.dtb" 262144 32
