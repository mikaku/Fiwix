...
int minix_file_llseek(struct inode *, __off_t);
...
int ext2_file_llseek(struct inode *, __off_t);
...
int pipefs_llseek(struct inode *, __off_t);
...
int iso9660_file_llseek(struct inode *, __off_t);
...
int procfs_file_llseek(struct inode *, __off_t);
